define(['phaser', 'lodash', 'board', 'candy'], function(Phaser, _, Board, Candy){


    var OligopolyApp = function(h, w, mode, targetElement){
        this.gameInstance = new Phaser.Game(h, w, mode, targetElement,{
            preload: OligopolyApp.preload,
            create: OligopolyApp.load,
            update: OligopolyApp.update,
            render: OligopolyApp.render
        });
    };

    OligopolyApp.prototype = {
